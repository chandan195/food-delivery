...
const addToCard = async (req, res) => {
  try {
    ...
    if (!cartData[req.body.itemId]) {
      ...
      // console.log(" if userData",cartData[req.body.itemId])
      // console.log(" if userData", userData.cartData)
    } else {
      cartData[req.body.itemId] += 1;
      // console.log(" else userData",cartData[req.body.itemId])
    }
    //  console.log("checking",cartData[req.body.userId])
